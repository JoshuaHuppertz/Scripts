...

{
    ...
    if [ -n "$l_pkgoutput" ]; then
        ...
        # Bestimme den Profilnamen basierend auf dem dconf db Verzeichnis
        if [ -f "$l_kfile" ]; then
        ...
        if [ -n "$l_gpname" ]; then
            ...
            # Überprüfe, ob die Profil-Datei existiert
            ...
            # Überprüfe, ob die dconf-Datenbank-Datei existiert
            ...
            # Einstellungen existieren nicht. Nichts weiter zu überprüfen
